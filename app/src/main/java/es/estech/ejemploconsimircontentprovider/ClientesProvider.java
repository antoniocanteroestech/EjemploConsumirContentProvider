...
public class ClientesProvider extends ContentProvider {
    ...
    private static final String uri =
            "content://es.estech.ejemploconsumircontentproviders/clientes";
    ...
    static {
        ...
        uriMatcher.addURI("es.estech.contentproviders", "clientes", CLIENTES);
        uriMatcher.addURI("es.estech.contentproviders", "clientes/#", CLIENTES_ID);
    }
    ...
    public String getType(Uri uri) {
        ...
        {
            case CLIENTES:
                return "vnd.android.cursor.dir/vnd.estech.cliente";
            case CLIENTES_ID:
                return "vnd.android.cursor.item/vnd.estech.cliente";
            default:
                return null;
        }
    }
